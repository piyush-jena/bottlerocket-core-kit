...
# Redirect the datastore fscrypt feature-flag enablement onto the LUKS mapper
# when BOTTLEROCKET-PRIVATE is fully encrypted (the encrypt-datastore.service.d
# dir is created above for the 20-ephemeral drop-in).
